...
namespace FluentLinqToSql.Modifications {
	...
	/// <summary>
	/// Defines modification that should be applied to a mapping before the XML is generated.
	/// </summary>
	public interface IMappingModification {
		/// <summary>
