...
namespace FluentLinqToSql.Mappings {
	...
	public interface IFunctionParameterMapping : IElementMapping, IHasAttributes {
		IFunctionParameterMapping DbType(string dbType);
		IFunctionParameterMapping Named(string name);
	}
}